...
export function WhatsAppButton() {
  return (
    <a
      ...
      aria-label={`Chat on WhatsApp ${company.whatsappDisplay}`}
    >
      <WhatsAppIcon />
    </a>
  )
